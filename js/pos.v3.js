...
bindEvents() {
    ...
    try {
        ...
        if (this.dom.searchCustomerCheckout) this.dom.searchCustomerCheckout.addEventListener('input', debounce((e) => this.filterCustomers(e.target.value), 300));
        ...
        if (this.dom.customerSearchInput) {
            this.dom.customerSearchInput.addEventListener('input', debounce((e) => {
